...
<body>
        ...
        <div class="content">
            ...
            <div class="page-header slide-up">
                ...
                <div class="filter-buttons-container slide-up">
                    ...
                    <a href="ongoing.jsp" class="filter-btn active">On-going</a>
                        ...
                        <tbody>
                            <%
                                ...
                                try {
                                    ...
                                    String query = "SELECT f.*, l.*, p.percent " +
                                                  ...
                                                  "AND l.company_id = ? AND p.percent < 100";
                                    ...
                                    while (rs.next()) {
                                        ...
                                        String dueDate = rs.getString("due_date") != null ? rs.getString("due_date") : "Not set";
                            %>
                            <tr>
                                ...
                                <td data-title="Due Date" class="date-cell" style="color: var(--danger);"><%= dueDate %></td>
            ...
            <form action="EditProjectServlet" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="progress" name="progress" 
                           placeholder="Enter Progress (0-100)" min="0" max="100" required>
                </div>
    ...
    <script>
        ...
        document.addEventListener('keydown', function (event) {
            if (event.key === 'Escape') {
                if (emodal && emodal.classList.contains('active')) {
                    closeedit();
                }
            }
        });
