...
<body>
    ...
    <div class="container">
        ...
        <div class="page-header">
            ...
            <div class="button-group" style="display: flex; gap: 10px;">
                <a href="empdashboared.jsp" class="btn btn-primary"><i class="fas fa-users"></i> Leads</a>
        ...
        <div class="employee-details">
            <%
                try {
                    vString host = System.getenv("DB_HOST");
            ...
            Class.forName("com.mysql.cj.jdbc.Driver");
                    ...
                    PreparedStatement empStmt = con.prepareStatement("SELECT * FROM emp WHERE unique_id = ?");
                    empStmt.setString(1, uniqueId);
                    ResultSet empRs = empStmt.executeQuery();
                    
                    if (empRs.next()) {
            %>
            <span><i class="fas fa-id-card"></i> Emp ID: <%= empRs.getString("unique_id") %></span>
            <span><i class="fas fa-user"></i> Emp Name: <%= empRs.getString("emp_name") %></span>
            <%
                    }
                    empRs.close();
                    empStmt.close();
                        ...
                        %>
                            <tr>
                                ...
                                <td data-title="Actions">
                                    <form action="MoveTaskServlet" method="post" style="display: flex; gap: 5px; align-items: center;">
                                        <input type="hidden" name="source" value="open">
                                        <input type="hidden" name="task_id" value="<%= rs.getInt("task_id") %>">
                                        <select name="category" class="form-control" required style="flex: 1;">
                                            <option value="">Move to...</option>
                                            <option value="in_progress">In Progress</option>
                                            <option value="completed">Completed</option>
                                        </select>
                                        <button type="submit" class="action-btn" style="background: var(--accent); color: white;">
    ...
    <script>
        ...
        function closeMessageModal() {
            ...
            window.location.href = 'leademptask.jsp';
        }
