    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="page-header slide-up">
                <h1 class="page-title">Testing Projects</h1>
                <div class="filter-buttons-container slide-up">
                    ...
                    <a href="testing.jsp" class="filter-btn active">Testing</a>
                </div>
            </div>
            ...
            Class.forName("com.mysql.cj.jdbc.Driver");
                            ...
                            <tr>
                                ...
                                <td data-title="Status">
                                    <form method="POST" action="deliveredproduct.jsp">
                                        <input type="hidden" name="lead_id" value="<%= leadId %>">
                                        <button type="submit" class="action-btn status" name="status" value="<%= status.equals("Delivered") ? "Not Delivered" : "Delivered" %>">
                                            <i class="fas fa-<%= status.equals("Delivered") ? "check-circle" : "hourglass-half" %>"></i> <%= status %>
                                        </button>
                                    </form>
                                </td>
                                <td data-title="Actions" style="white-space: nowrap;">
                                    <button class="action-btn delete" onclick="confirmDelete(<%= leadId %>)">
                            ...
                            <%
                                    ...
                                    if (!hasResults) {
                                        out.println("<tr><td colspan='6' style='text-align:center; color:var(--danger);'>No testing projects found</td></tr>");
                                    }
                                    ...
                                    e.printStackTrace();
                                    out.println("<tr><td colspan='6' style='text-align:center; color:var(--danger);'>Error fetching data</td></tr>");
                                }
                            %>
                        </tbody>
                    </table>
